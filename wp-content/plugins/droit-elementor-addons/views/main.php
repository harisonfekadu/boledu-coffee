<?php $pro_doc_upgrade = \DROIT_ELEMENTOR\Utils::droit_addons_doc_link(); ?>
<div class="dl_addons_element">
    ...
    <div class="dl_addons_row">
      <div class="dl_col_lg_12">
        <div class="dl_element_addons_dashboard_intro">
          <img src="<?php echo DROIT_EL_ADDONS_IMAGE . 'addons-logo-white.svg'; ?>" alt="Main Banner">
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="dl_addons_row dl_flex_item_center">
      <div class="dl_col_lg_6">
        <div class="dl_single_library_box">
          <img src="<?php echo DROIT_EL_ADDONS_IMAGE . 'documentation.png'; ?>" alt="Documentation" class="dl_box_icon">
          ...
          <a href="<?php echo $pro_doc_upgrade; ?>" target="_blank" class="cu_btn dl_gradient_btn btn_1 dl-btn-small"><?php esc_html_e('Check Documentation', 'droit-elementor-addons'); ?></a>
        </div>
      </div>
      <div class="dl_col_lg_6">
        <div class="dl_single_library_box">
          <img src="<?php echo DROIT_EL_ADDONS_IMAGE . 'need_help.png'; ?>" alt="Need Help?" class="dl_box_icon">
          ...
          <a href="https://github.com/droitlab/droit-elementor-addons-community" target="_blank" class="cu_btn dl_gradient_btn btn_1 dl-btn-small "><?php esc_html_e('Seek Help From Community', 'droit-elementor-addons'); ?></a>
        </div>
      </div>
      <div class="dl_col_lg_6">
        <div class="dl_kit_section_title style_3 mr-left">
          <div class="dl_section_title_icon">
            <img src="<?php echo DROIT_EL_ADDONS_IMAGE . 'mising_feature.svg'; ?>" alt="Missing Features" class="dl_box_icon">
          </div>
      ...
      <div class="dl_col_lg_6">
        <div class="dl_single_library_box dl_thumbnail">
          <img src="<?php echo DROIT_EL_ADDONS_IMAGE . 'setting_img.png'; ?>" alt="Settings Image">
          <img src="<?php echo DROIT_EL_ADDONS_IMAGE . 'setting_shape.png'; ?>" alt="Settings shape" class="dl_addons_setting_shape">
        </div>
      </div>
      <div class="dl_col_lg_6">
        <div class="dl_single_library_box">
          <h5 class="title"><?php esc_html_e('Show Your Love', 'droit-elementor-addons'); ?></h5>
          <img src="<?php echo DROIT_EL_ADDONS_IMAGE . 'show_loves.svg'; ?>" alt="Show Your Love" class="dl_box_icon">
          <p class="description">
      ...
      <div class="dl_col_lg_6">
        <div class="dl_single_library_box">
          ...
          <img src="<?php echo DROIT_EL_ADDONS_IMAGE . 'contribute.svg'; ?>" alt="Contribute to Droit Elementor Adons"
            class="dl_box_icon">
          <p class="description">
  ...
  <div class="dl_addons_container">
    <div class="dl_addons_row">
      <div class="dl_col_lg_6">
        <div class="dl_kit_section_title style_2">
          <div class="dl_section_title_icon">
            <img src="<?php echo DROIT_EL_ADDONS_IMAGE . 'video.svg'; ?>" alt="#" class="dl_box_icon">
          </div>
          <div class="dl_section_title_content">
    ...
    <div class="dl_addons_row">
      <?php $_demos =  DROIT_ELEMENTOR\Admin_Dashboard::droit_youtube_demo();
            if( $_demos > 0 ):
