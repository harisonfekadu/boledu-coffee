  <div id="wrap_popup1" class="ajax_message message_ajax">
    ...
    <?php if (!\DROIT_ELEMENTOR\Utils::droit_addons_has_pro()): ?>
	   <div id="wrap_popup1" class="ajax_message pro_ajax_message">
        <div class="ajax_message_content">
            <div class="close-pro">
            <img class="pro-close" src="<?php echo DROIT_EL_ADDONS_IMAGE . 'close.png'; ?>" alt="DroitLab Elementor Addons">
        </div>
             <div class="pro-icon">
                 <img class="pro-image" src="<?php echo DROIT_EL_ADDONS_IMAGE . 'pro_modal.svg'; ?>" alt="DroitLab Elementor Addons">
             </div>
...
<?php if (defined("DROIT_EL_PRO")): ?>
    <div id="wrap_popup1" class="ajax_message video_popup">
		<div class="ajax_message_content">
