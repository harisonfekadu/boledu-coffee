...
class Library_Api extends Source_Base {
	 ...
	 */
	const API_INFO_URL = 'https://templates.droitthemes.com/wp-json/droit-elementor-addons/v1/templates-info.json';
	/**
	...
	const API_DATA_URL = 'https://templates.droitthemes.com/wp-json/droit-elementor-addons/templates/%d.json';
	...
	public function get_title() {
		return __( 'Droit Addons Library', 'droit-elementor-addons' );
	}
	...
	public function get_data( array $args, $context = 'display' ) {
		...
		if ( empty( $data ) || empty( $data['content'] ) ) {
			throw new \Exception( __( 'Template does not have any content', 'droit-elementor-addons' ) );
		}
