...
use \DROIT_ELEMENTOR\Templates\Library_Api;
...
class Load_Template{
    ...
    public static function load_template_views() {
        include_once DROIT_EL_ADDONS_DIR_PATH . '/modules/templates/views/templates.php';
    }
    /**
        ...
        $ajax->register_ajax_action( 'get_lite_library_data', function( $data ) {
            ...
            if ( ! empty( $data['editor_post_id'] ) ) {
                ...
                if ( ! get_post( $editor_post_id ) ) {
                    throw new \Exception( __( 'Post not found.', 'droit-elementor-addons' ) );
                }
