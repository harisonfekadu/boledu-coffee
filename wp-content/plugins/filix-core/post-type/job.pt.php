...
class Job {
    ...
    public function register() {
        ...
        register_taxonomy($this->type.'_cat', $this->type, array(
            ...
            'labels'                => array(
                'name'  => $this->singular_name.esc_html__(' Categories', 'filix-core'),
            )
        ));
        ...
        register_taxonomy($this->type.'_location', $this->type, array(
            ...
            'show_in_nav_menus'     => false,
            'labels'                => array(
                'name'  => $this->singular_name.esc_html__(' Locations', 'filix-core'),
            )
        ));
        ...
        register_taxonomy($this->type.'_type', $this->type, array(
            ...
            'show_in_nav_menus'     => false,
            'labels'                => array(
                'name'  => $this->singular_name.esc_html__(' Type', 'filix-core'),
            )
        ));
    }
