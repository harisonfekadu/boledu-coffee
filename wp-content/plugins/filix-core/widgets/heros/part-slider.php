<section class="hero_warp">
    ...
    <div class="bg_img_slider_wrap">
        <div class="bg_img_slider">
            <?php if(!empty($sliders)) {
                foreach ($sliders as $single_slide) { ?>
                    <?php if(!empty($single_slide['slider_img'])) : ?>
                        <div class="bg_img_slider_item">
                            <img src="<?php echo esc_url($single_slide['slider_img']['url']); ?>" alt="slider Img">
                        </div>
                    <?php endif; ?>
                <?php }
            }
