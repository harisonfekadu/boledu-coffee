...
$is_sticky_header = isset($opt['is_sticky_header']) ? $opt['is_sticky_header'] : '1';
$is_sticky_header = $is_sticky_header == '1' ? ' sticky_header' : '';
?>
<header class="header header_style_one<?php echo esc_attr($is_sticky_header) ?>">
    <div class="container">
        <div class="row">
                ...
                <nav class="navbar navbar-expand-lg">
                    ...
                    <?php if ( has_nav_menu('main-menu') ) : ?>
                        ...
                        <div class="collapse navbar-collapse header_menu mb_hide" id="header_menu">
                            <?php
                            $menu_align = is_rtl() ? 'mr' : 'ml';
                            wp_nav_menu( array (
                                'theme_location'    => 'main-menu',
                                'depth'             => 3,
                                'container'         => false,
                                'menu_class'        => "navbar-nav $menu_align-auto",
