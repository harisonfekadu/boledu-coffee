...
$args = array(
	...
	'menu_title'           => esc_html__( 'Theme Settings', 'filix' ),
	'page_title'           => esc_html__( 'Filix Theme Settings', 'filix' ),
...
$args['footer_text'] = esc_html__( 'Copyright Filix &copy; 2019', 'filix' );
...
$tabs = array(
	array(
		'id'      => 'theme_help_links',
		'title'   => esc_html__( 'Theme help links', 'filix' ),
		'content' => wp_kses(__( '
						<p><a href="http://docs.droitthemes.com/docs/filix-docs/" target="_blank">Documentation</a></p>
						<p><a href="http://docs.droitthemes.com/docs/filix-docs/changes-log/" target="_blank">Theme changes log</a></p>
						', 'filix' ), $allowed_string)
	),
);
...
require get_template_directory().'/options/opt_job.php';
/*
 * <--- END SECTIONS
 */