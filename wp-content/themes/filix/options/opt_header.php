<?php
Redux::set_section('filix_opt', array(
...
Redux::set_section('filix_opt', array(
    ...
    'fields'           => array(
        ...
        array(
            'id'        => 'menu_bottom',
            'type'      => 'switch',
            'title'     => esc_html__( 'Overlay Menu Bottom', 'filix'),
        ...
        array(
            'id'        => 'is_sticky_header',
            'type'      => 'switch',
            'title'     => esc_html__( 'Sticky Header', 'filix' ),
...
Redux::set_section('filix_opt', array(
    ...
    'fields'           => array(
        ...
        array(
            ...
            'output'      => array('header.header .navbar .logo .logo_text:before'),
        ...
        array(
            ...
            'output'    => array('header.header .navbar .logo .logo_text'),
            'required'  => array('logo_select', '=', '1')
        ),

        array (
            'title'     => esc_html__( 'Main Logo', 'filix' ),
        ...
        array (
            'title'     => esc_html__( 'Sticky Logo', 'filix' ),
            'subtitle'  => esc_html__( 'Upload here a image file for your logo. This logo will display on the sticky header only.', 'filix' ),
            'id'        => 'sticky_main_logo',
            'type'      => 'media',
            'required'  => array ('logo_select', '=', '2'),
        ),
...
Redux::set_section( 'filix_opt', array(
    ...
    'fields'           => array(
        array(
            ...
            'mode'      => 'background',
            'output'    => array("header.header.header_style_one")
        ),
        ...
        array(
            ...
            'mode'      => 'background',
            'output'    => array("header.header.header_style_one.fixedMenu")
        ),
    )
));
...
Redux::set_section('filix_opt', array(
    ...
    'fields'           => array(
        ...
        array(
            ...
            'output'    => array('.hero_warp .banner_content .banner_title')
        ),
